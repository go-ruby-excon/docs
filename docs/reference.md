...
The public API lives at the module root (`github.com/go-ruby-excon/excon`). It is
**Ruby-shaped but Go-idiomatic**: names mirror Ruby's `excon`, while the surface follows
...
```go
import "github.com/go-ruby-excon/excon"
```
...
- **[pkg.go.dev/github.com/go-ruby-excon/excon](https://pkg.go.dev/github.com/go-ruby-excon/excon)**

The module's [README](https://github.com/go-ruby-excon/excon#readme) carries worked
