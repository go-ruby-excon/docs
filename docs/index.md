# go-ruby-excon documentation

**Pure-Go, MRI-4.0.5-faithful Ruby excon (no cgo)**

`go-ruby-excon/excon` is a faithful, pure-Go (zero cgo) reimplementation of Ruby's `excon`,
...
!!! success "Status: pure-Go, CGO=0, differential-tested"
    A faithful pure-Go port of Ruby's `excon`, validated against reference Ruby, at 100%
...
| Repo | What it is |
| --- | --- |
| [`excon`](https://github.com/go-ruby-excon/excon) | the library — Ruby's `excon` in pure Go |
| [`docs`](https://github.com/go-ruby-excon/docs) | this documentation site (MkDocs Material, versioned with mike) |
| [`go-ruby-excon.github.io`](https://github.com/go-ruby-excon/go-ruby-excon.github.io) | the organization landing page (Hugo) |
| [`brand`](https://github.com/go-ruby-excon/brand) | logo and brand assets |
...
Source lives at [github.com/go-ruby-excon/excon](https://github.com/go-ruby-excon/excon).
